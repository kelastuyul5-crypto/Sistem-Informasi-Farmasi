          ...
          <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg bg-slate-800 border border-slate-700 hover:border-teal-500/40 transition-all cursor-pointer">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10px] text-slate-500">
                {user?.hospital || "Loading..."}
              </p>
            </div>
          </div>
          {/* Dropdown Menu (Hover) */}
          <div className="absolute right-0 top-full mt-2 w-48 rounded-xl bg-slate-800 border border-slate-700 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 origin-top-right">
            <div className="p-2">
              <button
                onClick={logout}
                className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors"
              >
